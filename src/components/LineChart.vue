	...
	<div id="line-chart">
		<div id="selectSection">
			...
			<select name="category" id="category" @change="onGenerate()" >
				...
				<!-- <option value="wounded">Population3</option> -->
			</select>
		</div>
	...
	export default {
		...
		methods: {
			init: function() {
				...
				xAxis = d3.axisBottom().scale(x).ticks((2021 - 1950) / 5).tickFormat(d3.format("d"));
				...
				let mousemove = function(e) {
					...
					text1.text('Year: ' + selectedData.year)
				...
				this.update(procData(1, 'population'))
			},
